...
export default function Home({ params }) {
  ...
  const formatedCmsUrl = params
    ? `${backgroundImgUrl}?fm=webp&w=2000&h=2000`
    : null;
  ...
  return (
    <div className={styles.containerMain}>
        <Head>
          <link
            rel="icon"
            href="/showcase-round-726-svgrepo-com.svg"
            type="image/png"
          />
        ...
        <div className={styles.github}>
          CodeBase Link
          <a
            href="https://github.com/NuminousCode/mongo-crud-app"
            target="_blank"
